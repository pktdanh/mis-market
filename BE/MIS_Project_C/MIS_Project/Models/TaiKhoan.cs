    ...
    public class TaiKhoan
    {
        ...
        public TaiKhoan(string accountID)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    this.KichHoat = dr["KichHoat"].ToString();
                }
                con.Close();
            }
            catch (Exception exc)
        ...
        public TaiKhoan checkLogin(TaiKhoan logAccount)
        {
            ...
            foreach(TaiKhoan account in accounts)
            {
                ...
                {
                    if (account.KichHoat == "0")
                    {
                        logAccount.Password = "";
                        logAccount.KichHoat = account.KichHoat;
                    }
